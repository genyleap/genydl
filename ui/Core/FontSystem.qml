/*!
    \file        FontSystem.qml
    \brief       Provides the FontSystem core QML definition for TONDAR.
    \details     This file contains shared FontSystem values and behavior used across the TONDAR QML user interface.
