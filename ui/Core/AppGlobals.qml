/*!
    \file        AppGlobals.qml
    \brief       Provides the AppGlobals core QML definition for TONDAR.
    \details     This file contains shared AppGlobals values and behavior used across the TONDAR QML user interface.
