/*!
    \file        Typography.qml
    \brief       Provides the Typography core QML definition for TONDAR.
    \details     This file contains shared Typography values and behavior used across the TONDAR QML user interface.
