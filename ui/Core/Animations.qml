/*!
    \file        Animations.qml
    \brief       Provides the Animations core QML definition for TONDAR.
    \details     This file contains shared Animations values and behavior used across the TONDAR QML user interface.
