/*!
    ...
    \brief       Implements the CommandAddUrlButton QML component for TONDAR.
    \details     This file contains the CommandAddUrlButton user interface component used by the TONDAR desktop application.
...
import Tondar // Colors, FontSystem
