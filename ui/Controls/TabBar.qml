/*!
    \file        TabBar.qml
    \brief       Implements the TabBar QML component for TONDAR.
    \details     This file contains the TabBar user interface component used by the TONDAR desktop application.
