/*!
    ...
    \brief       Implements the AppMenuTrigger QML component for TONDAR.
    \details     This file contains the AppMenuTrigger user interface component used by the TONDAR desktop application.
