/*!
    ...
    \brief       Implements the ProgressBar QML component for TONDAR.
    \details     This file contains the ProgressBar user interface component used by the TONDAR desktop application.
