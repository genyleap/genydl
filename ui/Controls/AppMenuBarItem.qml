/*!
    ...
    \brief       Implements the AppMenuBarItem QML component for TONDAR.
    \details     This file contains the AppMenuBarItem user interface component used by the TONDAR desktop application.
