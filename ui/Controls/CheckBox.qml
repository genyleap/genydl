/*!
    \file        CheckBox.qml
    \brief       Implements the CheckBox QML component for TONDAR.
    \details     This file contains the CheckBox user interface component used by the TONDAR desktop application.
