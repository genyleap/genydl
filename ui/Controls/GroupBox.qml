/*!
    \file        GroupBox.qml
    \brief       Implements the GroupBox QML component for TONDAR.
    \details     This file contains the GroupBox user interface component used by the TONDAR desktop application.
