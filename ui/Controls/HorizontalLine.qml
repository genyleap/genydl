/*!
    ...
    \brief       Implements the HorizontalLine QML component for TONDAR.
    \details     This file contains the HorizontalLine user interface component used by the TONDAR desktop application.
