/*!
    ...
    \brief       Implements the VerticalLine QML component for TONDAR.
    \details     This file contains the VerticalLine user interface component used by the TONDAR desktop application.
